...
AI_ARTICLES: dict[str, dict] = {
    ...
    "Out-of-Time Evaluation": {
        ...
        "body": (
            ...
            "calibrated LightGBM scores PR-AUC 0.239, ROC-AUC 0.806, and recall at the top-200 "
            "review budget of 47.0%.\n\n"
            ...
            "[0.141, 0.370], ROC-AUC about [0.734, 0.869], recall@k about [0.344, 0.581]. To "
            ...
            "about [+0.060, +0.205] and the model beats the logit in 100% of resamples. The "
    ...
    "Model Risk and Governance": {
        ...
        "body": (
            ...
            "about 0.806 sits well below the level that would suggest leakage, which is itself "
            ...
            "boosted model beats it on the rare-event metric (PR-AUC 0.239 versus 0.112) and on "
            "recall@k. Because that margin rests on 66 positives, it is reported as a paired "
            "bootstrap rather than a bare comparison: difference 95% CI about [+0.060, +0.205], "
            "P(model beats logit) about 100%. The benchmark and the paired test live in "
            "[[Out-of-Time Evaluation]].\n\n"
